...
export default {
  ...
  async mounted() 
  {
    ...
    const auth0Domain = "dev-fwkbpfvs14v5kh8o.us.auth0.com";
    const audience = "http://localhost:7356";
    const clientId = "SBbWBwAJDV5qipqNNKaWaKYTEgS2fmjC";
    const clientSecret = "_Vw9LzdPgiRIvIyW1VZGGvTyaVWEqPEOiIJfNjvFFeDtveo44KjWMX2W_WRcQKh3";
